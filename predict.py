...
def main():
    ...
    nt_onehot=h5py.File(os.getcwd()+'/tmp/nt_onehot.mat')
    condon_onehot=h5py.File(os.getcwd()+'/tmp/condon_onehot.mat')
    nt_length=np.loadtxt(os.getcwd()+'/tmp/nt_length.csv',delimiter=',')
    condon_length=np.loadtxt(os.getcwd()+'/tmp/condon_length.csv',delimiter=',')
    ...
    np.savetxt(os.getcwd()+'/tmp/predict.csv',predict)
    del model
